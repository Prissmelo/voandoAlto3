...
<title>Agência Voando Alto-Lista de Clientes</title>
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
 <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
   ...
   <link rel="shortcut icon" href="Avião.ico" type="image/x-icon">
  ...
  <header>     
         <nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgba(22, 79, 133, 0.959);">
            <div class="container-fluid">
               <div class="logo">
                  <a href=""><img src="Mapa.ico" alt="Icone da Agência" width="50" height="50" class="d-inline-block align-text-top"></a> 
              ...
              <div class="nav-list" id="navbarSupportedContent">
                 <ul class="navbar-nav me-auto mb-4 mb-lg-0">
                   ...
                   <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle text-light" href="promocao.html" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="true">Promoções</a>
    ...
    <br>
         <!--___________________________________________________________________________________________Lista de Clientes para deletar e atualizar_______________________________________________________________  -->
    ...
    <div class="container">
            <div class="row">
                  <div class="cold-md-7">
                    ...
                    <table class="table">
                         ...
                         <c:forEach items="${clientes}" var="cliente">
                                      <tr>
                                          ...
                                          <td>${cliente.email}</td>
                                            <td>
                                               <a href="DeletarCliente?clienteId=${cliente.id}">Deletar </a>
                                             <br>
                                               <a href="ClienteAlterado?clienteId=${cliente.id}">Atualizar </a>
                                           </td>
                                      </tr>
                           </c:forEach>
                    ...
                    <a href="Index.html"><h5>Retornar para o cadastro de Clientes</h5></a>
                    </br>
                  </div>
            </div>
   ...
   <!--___________________________________________________________________________________________Rodapé do site_______________________________________________________________  -->
