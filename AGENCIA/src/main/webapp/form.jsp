...
<title>Agência Voando Alto-Atualização</title>
...
<header>
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgba(22, 79, 133, 0.959);">
    ...
    <br>
     ...
     <!--___________________________________________________________________________________________Lista de Atualização do Cadastro_______________________________________________________________  -->
    
 <div class="container">
              <div class="row" style="align-items: center">
                    <div class="cold-md-7">
                         <hr>
                         <h3>Atualização de dados dos Clientes</h3>
                         <hr>
                         ...
                         <form action="ClienteAlterado" method="POST">
					          ...
					          <select name="situacao" class="form-select mb-3" aria-label="Default select example">
						           <option value="Inativo" selected>--Selecionar a Situação</option>
